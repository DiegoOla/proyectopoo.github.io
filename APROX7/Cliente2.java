...
/**
 * Write a description of class EstudianteColegio here.
 * 
 * @author (your name) 
...
public class Cliente2 extends Cliente{
    ...
    Cliente2(String identificacion, String nombre, String sede, double calificacionuno, double calificaciondos, double calificaciontres)throws Exception{
